...
//                        }){
                 ...
                 //       }
                        ...
                        NavigationLink(destination: GalleryScreen(), tag: "GalleryScreen", selection: $viewDestination) {
                            Button(action: {
                                self.viewDestination = "GalleryScreen"
                            }){
                                HStack{
                                    Text("Gallery")
                                        .bold()
                        ...
                        NavigationLink(destination: AboutScreen(), tag: "AboutScreen", selection: $viewDestination) {
                            Button(action: {
                                self.viewDestination = "AboutScreen"
                            }){
                                HStack{
                                    Text("About")
                                        .bold()
